      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          <ProductCard
            ...
            description="Nourishing blend of natural oils for a healthy, shiny beard."
            price="$29.99"
          />
          <ProductCard
            ...
            description="Strong hold matte finish pomade for perfect styling."
            price="$24.99"
          />
          <ProductCard
            ...
            alt="Shaving Cream"
            title="Luxury Shaving Cream"
            description="Rich lather cream for the smoothest shaving experience."
            price="$34.99"
          />
          <ProductCard
            ...
            description="Complete grooming kit with premium tools and products."
            price="$89.99"
          />
        </div>
      </div>
